...
count= 340
annotation = scipy.io.loadmat(r"C:\Users\andre\Desktop\foto and labels\wider_face_split\wider_face_split\wider_face_val.mat")
    ...
    if 1 == 1: 
        ...
        for j in range(len(annotation['file_list'][i,0])):
            ...
            if 1 == 1: 
                ...
                path_lettura = "C:\\Users\\andre\\Desktop\\foto and labels\\WIDER_val\\WIDER_val\\images\\" + event + "\\" + filename
                path_scrittura = "C:\\Users\\andre\\Desktop\\wider_VAL_subset_images\\images\\"
                file_da_scrivere = "C:\\Users\\andre\\Desktop\\wider_VAL_subset_images\\images\\" + filename
                ...
                if (os.path.exists(r'C:\Users\andre\Desktop\wider_VAL_subset_images\annots' + "\\" + str(count) + ".txt") == False):
                    file1 = open(r'C:\Users\andre\Desktop\wider_VAL_subset_images\annots' + "\\" + str(count) + ".txt", "w")
                    file1.close()
            
                file1 = open(r'C:\Users\andre\Desktop\wider_VAL_subset_images\annots' + "\\" + str(count) + ".txt", "a") 
                ...
                if not (swapped_bbxs[0][0] == 0 and swapped_bbxs[0][1] == 0   and swapped_bbxs[0][2] == 0 and swapped_bbxs[0][3] == 0):
                    ...
                    if len(swapped_bbxs) == 1 and person_1 < 125:
                        ...
                        for k in range(len(swapped_bbxs)):
                            ...
                            #print(perc)
                            if perc < 10:
                                if (os.path.exists(r'C:\Users\andre\Desktop\wider_VAL_subset_images\annots' + "\\" + str(count) + ".txt") == True):
                                    file1.close()
                                    os.remove(r'C:\Users\andre\Desktop\wider_VAL_subset_images\annots' + "\\" + str(count) + ".txt")
                                    ok = 0
                                    break
                            else:
